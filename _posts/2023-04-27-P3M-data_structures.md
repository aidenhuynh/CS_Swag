...
#################################################
# file to edit: _notebooks/2023-04-27-P3M-data_structures.ipynb
-->
...
<pre>(node:33303) UnhandledPromiseRejectionWarning: ReferenceError: fetch is not defined
    at getList (evalmachine.&lt;anonymous&gt;:4:16)
...
(node:33303) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). (rejection id: 2)
(node:33303) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
</pre>
</div>
</div>
...
<li>Images are stored in the backend as they regularly are, then returned as base64 to the frontend.</li>
</ul>
</li>
<li>What is the <code>fetch()</code> function and how is it used in frontend logic?<ul>
<li>the fetch function is used to access the api using different methods.</li>
</ul>
</li>
<li>How is data formatted and sent to the backend? (mention JSON in your answer)<ul>
<li>Data is formatted into JSON which gets appended/added to the backend.</li>
</ul>
</li>
</ol>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="HACKS!!!!">HACKS!!!!<a class="anchor-link" href="#HACKS!!!!"> </a></h1><h3 id="Full-stack-screenshots:">Full stack screenshots:<a class="anchor-link" href="#Full-stack-screenshots:"> </a></h3><p>img img img</p>
<h3 id="Quick-sort-algorithm">Quick sort algorithm<a class="anchor-link" href="#Quick-sort-algorithm"> </a></h3>
</div>
</div>
</div>
    {% raw %}
...
<span class="k">def</span> <span class="nf">getRandList</span><span class="p">(</span><span class="n">maxNums</span><span class="p">):</span>
    <span class="c1"># Define unsorted list</span>
    <span class="n">randomList</span> <span class="o">=</span> <span class="p">[]</span>

    <span class="c1"># Add random numbers to the list</span>
    <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">maxNums</span><span class="p">):</span>
        <span class="n">randomList</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">random</span><span class="o">.</span><span class="n">randint</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">100</span><span class="p">))</span>
        
    <span class="k">return</span> <span class="n">randomList</span>
    
<span class="k">def</span> <span class="nf">partition</span><span class="p">(</span><span class="nb">list</span><span class="p">,</span> <span class="n">start</span><span class="p">,</span> <span class="n">end</span><span class="p">):</span>
    <span class="c1"># Assign pivot to last value</span>
    <span class="n">pivot</span> <span class="o">=</span> <span class="nb">list</span><span class="p">[</span><span class="n">end</span><span class="p">]</span>
    
    <span class="n">tempPivotIndex</span> <span class="o">=</span> <span class="n">start</span> <span class="o">-</span> <span class="mi">1</span>
    
    <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">start</span><span class="p">,</span> <span class="n">end</span><span class="p">):</span>
        <span class="k">if</span> <span class="nb">list</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">&lt;=</span> <span class="n">pivot</span><span class="p">:</span>
            <span class="n">tempPivotIndex</span> <span class="o">+=</span> <span class="mi">1</span>
            
            <span class="c1"># Swapsies!</span>
            <span class="nb">list</span><span class="p">[</span><span class="n">i</span><span class="p">],</span> <span class="nb">list</span><span class="p">[</span><span class="n">tempPivotIndex</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">[</span><span class="n">tempPivotIndex</span><span class="p">],</span> <span class="nb">list</span><span class="p">[</span><span class="n">i</span><span class="p">]</span>
            
    <span class="n">tempPivotIndex</span> <span class="o">+=</span> <span class="mi">1</span>
    
    <span class="c1"># Swapsies again1!! (I literally have no idea what I&#39;m doing bro)</span>
    <span class="nb">list</span><span class="p">[</span><span class="n">tempPivotIndex</span><span class="p">],</span> <span class="nb">list</span><span class="p">[</span><span class="n">end</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">[</span><span class="n">end</span><span class="p">],</span> <span class="nb">list</span><span class="p">[</span><span class="n">tempPivotIndex</span><span class="p">]</span>
    
    <span class="k">return</span> <span class="n">tempPivotIndex</span>
    
<span class="k">def</span> <span class="nf">qSort</span><span class="p">(</span><span class="nb">list</span><span class="p">,</span> <span class="n">start</span><span class="p">,</span> <span class="n">end</span><span class="p">):</span>
    <span class="k">if</span> <span class="n">start</span> <span class="o">&gt;=</span> <span class="n">end</span> <span class="ow">or</span> <span class="n">start</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="p">:</span>
        <span class="k">return</span>
    
    <span class="n">pivotIndex</span> <span class="o">=</span> <span class="n">partition</span><span class="p">(</span><span class="nb">list</span><span class="p">,</span> <span class="n">start</span><span class="p">,</span> <span class="n">end</span><span class="p">)</span>
    
    <span class="n">qSort</span><span class="p">(</span><span class="nb">list</span><span class="p">,</span> <span class="n">start</span><span class="p">,</span> <span class="n">pivotIndex</span> <span class="o">-</span> <span class="mi">1</span><span class="p">)</span>
    <span class="n">qSort</span><span class="p">(</span><span class="nb">list</span><span class="p">,</span> <span class="n">pivotIndex</span> <span class="o">+</span> <span class="mi">1</span><span class="p">,</span> <span class="n">end</span><span class="p">)</span>

<span class="c1"># Number of elements in the list</span>
<span class="n">elements</span> <span class="o">=</span> <span class="mi">10</span>

<span class="c1"># Define random list of __ elements</span>
<span class="n">randomList</span> <span class="o">=</span> <span class="n">getRandList</span><span class="p">(</span><span class="n">elements</span><span class="p">)</span>

<span class="c1"># wejfasdfls;kjfa</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Unsorted list:</span><span class="se">\n</span><span class="s2">&quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">randomList</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot;</span><span class="se">\n</span><span class="s2">&quot;</span><span class="p">)</span>

<span class="c1"># Sort</span>
<span class="n">qSort</span><span class="p">(</span><span class="n">randomList</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="n">elements</span> <span class="o">-</span> <span class="mi">1</span><span class="p">)</span>

<span class="c1"># POW</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Sorted list:</span><span class="se">\n</span><span class="s2">&quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">randomList</span><span class="p">))</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Unsorted list:
[52, 35, 28, 87, 24, 41, 96, 87, 88, 81]

Sorted list:
[24, 28, 35, 41, 52, 81, 87, 87, 88, 96]
</pre>
</div>
</div>
